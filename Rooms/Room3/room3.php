            ...
            if (isset($_SESSION['username']))
            {
              ...
              echo $_SESSION['username'];
                ...
                <ul>
                  ...
                  <li><a href='../rooms.php'><i class='fas fa-angle-right'></i><i class='fas fa-bed'></i> Rooms</a></li>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12 text-center">
            <h1 class="display-4 mt-5">Triple room</h1>
          </div>
        </div>
        <div class="row">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="px-md-5 p-3 d-flex flex-column justify-content-center col-lg-6 order-1 order-lg-3">
            ...
            <p class="lead">
              These rooms designed with open-concept living area are very bright and
                spacious – they come with three beds. The interior is made with a warm palette tons of
                walls and furniture.
            </p>
            <div class="form-group"><label>Triple Room</label></div>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
              <?php
                ...
                $query = "SELECT * FROM rooms WHERE type='triple' AND status='available'";
      ...
      if(isset($_GET['submit']))
      {
        if (isset($_SESSION['username']))
        {
            ...
            else
            {
              ...
              echo '<meta http-equiv="refresh" content="0; URL=room3.php">';
            }
