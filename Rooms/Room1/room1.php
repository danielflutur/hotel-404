      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12 text-center">
            <h1 class="display-4 mt-5">Single room</h1>
          </div>
        </div>
        <div class="row">
          <div class="p-0 col-12">
            <img class="img-fluid d-block cover" src="img/single.jpg" width="100%">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
              <?php
                ...
                $query = "SELECT * FROM rooms WHERE type='single' AND status='available'";
                ...
                if($total != 0)
                {
                  ...
                  {
                      echo "<input type='text' value='". $result['roomNumber']."'class=form-control' id='form6' name='room_nr' required disabled>
                    </div>
                    <div class='form-group' style='transform: translateY(+25px);'>
                      <label class='m-0'>Price</label><br>
                      <input type='text' value='". $result['price']."'class=form-control' id='form6' name='price' required disabled>
                    </div>";
