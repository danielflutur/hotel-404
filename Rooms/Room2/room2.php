...
<body class="cover">
  ...
  <body>
    ...
    <div class="py-5 text-center gallery">
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-8 order-2 order-lg-1"> <img class="img-fluid d-block rounded" src="../../img/bucatarie2.jpg"> </div>
          <div class="col-lg-2 col-4 d-flex flex-column justify-content-between order-3 order-lg-2">
            <img class="img-fluid d-block rounded" src="../../img/toilet2.jpg">
            <img class="img-fluid d-block rounded" src="../../img/bath2.jpg">
          </div>
