...
<head>
    ...
    <link rel="stylesheet" href="clstaff_account.css">
...
<body>
    <nav>
        ...
        <ul class="links">
            ...
            <li><a href="clstaff_account.php"><i class="fas fa-angle-right"></i><i class="far fa-user-circle"></i>Manage account</a></li>
    ...
    <form class="change" action="">
        <table style="width: 80%; height: 100%; border-bottom: 1px solid grey; border-top: 1px solid;">
            ...
            <tr style="background-color: transparent;">
                <td>Old password</td>
                <td><input type="text" id="old_pass" name="old_passw" placeholder="Old password" required></td>
            </tr>
            <tr style="background-color: transparent;">
                <td>New password</td>
